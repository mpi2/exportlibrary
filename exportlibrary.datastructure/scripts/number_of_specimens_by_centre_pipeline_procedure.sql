...
select  CENTREPROCEDURE.CENTREID, CENTREPROCEDURE.PIPELINE,  PROCEDURE_.PROCEDUREID, COUNT(EXPERIMENT_SPECIMENID.HJVALUE)
...
GROUP BY CENTREPROCEDURE.CENTREID, CENTREPROCEDURE.PIPELINE, PROCEDURE_.PROCEDUREID
ORDER BY CENTREPROCEDURE.CENTREID, CENTREPROCEDURE.PIPELINE, PROCEDURE_.PROCEDUREID, EXPERIMENT_SPECIMENID.HJVALUE