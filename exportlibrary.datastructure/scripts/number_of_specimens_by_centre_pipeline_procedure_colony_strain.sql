...
select  CENTREPROCEDURE.CENTREID, CENTREPROCEDURE.PIPELINE,  PROCEDURE_.PROCEDUREID, SPECIMEN.COLONYID, SPECIMEN.STRAINID, COUNT(1)
...
phenodcc_context.context.isActive AND
...
GROUP BY CENTREPROCEDURE.CENTREID, CENTREPROCEDURE.PIPELINE, PROCEDURE_.PROCEDUREID, SPECIMEN.COLONYID, SPECIMEN.STRAINID
ORDER BY CENTREPROCEDURE.CENTREID, CENTREPROCEDURE.PIPELINE, PROCEDURE_.PROCEDUREID,  SPECIMEN.COLONYID, SPECIMEN.STRAINID