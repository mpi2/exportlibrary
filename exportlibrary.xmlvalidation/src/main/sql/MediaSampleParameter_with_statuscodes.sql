...
SELECT DISTINCT(MEDIASAMPLEPARAMETER.PARAMETERSTATUS )
...
JOIN phenodcc_raw.MEDIASAMPLEPARAMETER ON PROCEDURE_.HJID = MEDIASAMPLEPARAMETER.MEDIASAMPLEPARAMETER_PROCEDU_0
WHERE MEDIASAMPLEPARAMETER.PARAMETERSTATUS IS NOT NULL
AND LEFT(MEDIASAMPLEPARAMETER.PARAMETERSTATUS, IF (LOCATE(":", MEDIASAMPLEPARAMETER.PARAMETERSTATUS)>0, LOCATE(":", MEDIASAMPLEPARAMETER.PARAMETERSTATUS)-1, LENGTH
    (MEDIASAMPLEPARAMETER.PARAMETERSTATUS))) NOT IN
    ( SELECT CODE
