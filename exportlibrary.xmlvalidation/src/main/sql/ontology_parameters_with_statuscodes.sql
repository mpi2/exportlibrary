...
SELECT DISTINCT(ONTOLOGYPARAMETER.PARAMETERSTATUS)
...
WHERE ONTOLOGYPARAMETER.PARAMETERSTATUS IS NOT NULL
AND LEFT(ONTOLOGYPARAMETER.PARAMETERSTATUS, IF (LOCATE(":", ONTOLOGYPARAMETER.PARAMETERSTATUS)>0, LOCATE(":", ONTOLOGYPARAMETER.PARAMETERSTATUS)-1, LENGTH(ONTOLOGYPARAMETER.PARAMETERSTATUS))) NOT IN
    ( SELECT CODE
