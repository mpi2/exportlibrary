...
SELECT DISTINCT PROCEDUREMETADATA.PARAMETERSTATUS
...
JOIN phenodcc_raw.PROCEDUREMETADATA ON PROCEDURE_.HJID = PROCEDUREMETADATA.PROCEDUREMETADATA_PROCEDURE__0
WHERE PROCEDUREMETADATA.PARAMETERSTATUS IS NOT NULL
AND LEFT(PROCEDUREMETADATA.PARAMETERSTATUS, IF (LOCATE(":", PROCEDUREMETADATA.PARAMETERSTATUS)>0, LOCATE(":", PROCEDUREMETADATA.PARAMETERSTATUS)-1, LENGTH(PROCEDUREMETADATA.PARAMETERSTATUS))) NOT IN
    ( SELECT CODE
