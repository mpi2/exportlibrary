...
SELECT DISTINCT(MEDIAPARAMETER.PARAMETERSTATUS )
...
JOIN phenodcc_raw.MEDIAPARAMETER ON PROCEDURE_.HJID = MEDIAPARAMETER.MEDIAPARAMETER_PROCEDURE__HJ_0
WHERE MEDIAPARAMETER.PARAMETERSTATUS  IS NOT NULL
AND LEFT(MEDIAPARAMETER.PARAMETERSTATUS , IF (LOCATE(":", MEDIAPARAMETER.PARAMETERSTATUS )>0, LOCATE(":", MEDIAPARAMETER.PARAMETERSTATUS )-1, LENGTH(MEDIAPARAMETER.PARAMETERSTATUS ))) NOT IN
    ( SELECT CODE
