...
SELECT DISTINCT(SERIESMEDIAPARAMETER.PARAMETERSTATUS )
...
JOIN phenodcc_raw.SERIESMEDIAPARAMETER ON PROCEDURE_.HJID = SERIESMEDIAPARAMETER.SERIESMEDIAPARAMETER_PROCEDU_0
WHERE SERIESMEDIAPARAMETER.PARAMETERSTATUS  IS NOT NULL
 AND 
LEFT(SERIESMEDIAPARAMETER.PARAMETERSTATUS , IF (LOCATE(":", SERIESMEDIAPARAMETER.PARAMETERSTATUS )>0, LOCATE(":", SERIESMEDIAPARAMETER.PARAMETERSTATUS )-1, LENGTH(SERIESMEDIAPARAMETER.PARAMETERSTATUS ))) NOT
    IN
    ( SELECT CODE
