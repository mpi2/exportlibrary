...
public class Parser {
    ...
    public static ImpressProcedure getImpressProcedure(String procedureKey) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        HashOfString hashOfString = new HashOfString((org.apache.xerces.dom.ElementNSImpl) Resource.getProcedure(procedureKey));
