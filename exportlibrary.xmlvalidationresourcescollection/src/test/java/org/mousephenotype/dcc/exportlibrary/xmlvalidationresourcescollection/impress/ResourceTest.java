...
public class ResourceTest {
    ...
    public void testValidProcedure() {
        ...
        try {
            validProcedure = Resource.validProcedure(procedureID);
        } catch (Exception ex) {
            logger.error("", ex);
            Assert.fail();
        }
    ...
    public void testvalidParameter() {
        ...
        try {
            validParameter = Resource.validParameter(parameterID);
        } catch (Exception ex) {
            logger.error("", ex);
            Assert.fail();
        }
    ...
    public void testvalidPipeline() {
        ...
        logger.info("valid pipelines");
        for (String pipeline : pipelineKeys.getItem()) {
            logger.info(pipeline);
            try {
                validParameter = Resource.validPipeline(pipeline);
            } catch (Exception ex) {
                logger.error("", ex);
                Assert.fail();
            }
